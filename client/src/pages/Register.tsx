      ...
      <div className="flex-1 flex items-center justify-center relative z-10 w-full mt-12 md:mt-0">
        ...
        >
          ...
          <div className="text-center">
            <h2 className="text-4xl font-black text-white tracking-widest uppercase mb-4 font-mono">CREATE ACCESS</h2>
            <p className="text-muted text-sm font-mono tracking-widest uppercase">INITIALIZE IDENTITY</p>
          </div>
          ...
          <form className="w-full flex flex-col gap-10" onSubmit={handleSubmit}>
            ...
            <button 
              type="submit" 
              disabled={isLoading}
              className="group relative overflow-hidden bg-transparent border border-accent/50 text-accent hover:text-white hover:bg-accent/10 hover:border-accent rounded-full py-5 w-full font-bold text-lg tracking-[0.2em] uppercase transition-all duration-500 font-mono disabled:opacity-50"
            >
          ...
          <div className="text-center font-mono text-xs text-muted tracking-widest uppercase">
            EXISTING USER? <Link to="/login" className="text-white hover:text-accent transition-colors ml-2 font-bold border-b border-transparent hover:border-accent">AUTHORIZE</Link>
          </div>
        </motion.div>
      </div>
    </div>
